	...
	return (
		<>
			<div className="flex flex-col justify-center items-center mt-12">
				...
				{/* Date & Information */}
				<div className="flex lg:justify-center mx-auto  w-full relative ">
					{/* Date */}

					{/* Information */}
					<div className="bg-orangeCS border-[3px] border-black rounded-tl-[3rem] lg:rounded-tl-[6rem] lg:p-8 lg:pl-10 lg:py-9 text-white italic lg:w-[60%] w-[80%] h-[50%] font-medium text-xs lg:text-base p-2 px-8 pl-10 text-justify">
					...
					<Image
						src="/svg/date-rpl.svg"
						alt="date"
						height={176}
						width={176}
						className="lg:h-[176px] w-[115px] h-[115px] lg:w-[176px] transform lg:-translate-x-[10%] lg:-translate-y-[12%] absolute lg:static -right-2 -top-2"
					/>
				</div>

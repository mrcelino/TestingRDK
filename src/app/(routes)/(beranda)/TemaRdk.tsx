	...
	return (
		<div className="lg:justify-between mt-20 md:flex max-w-7xl mx-auto">
			...
			<div className="lg:w-[60%] md:w-3/4 md:ml-auto md:mr-0">
				<h1 className="lg:text-5xl text-2xl text-greenCS lg:w-[70%] bg-orangeCS border-black lg:border-4 border-2 rounded-tr-[50px] rounded-bl-[50px] lg:rounded-tr-[30px] lg:rounded-bl-[30px] lg:py-3 lg:px-10 text-center  mx-auto font-heading py-2 w-4/5 text-shadow-md">
					Tema RDK
				</h1>

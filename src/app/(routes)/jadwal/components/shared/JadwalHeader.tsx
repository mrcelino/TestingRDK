...
export default function JadwalHeader(){
  return (
    <div data-aos="fade-up" data-aos-duration="1000" className="relative flex w-[216px] h-[63px] md:w-[335px] md:h-[98px] lg:w-[635px] lg:h-[185px] bg-[#15575B] rounded-[50px] border lg:border-[3px] border-black mx-auto mt-12 md:mt-16 lg:mt-44 justify-center items-center ">
      ...
      {/* <h1 className="bg-clip-text bg-gradient-to-b from-[0.001%] from-black/65 to-white text-transparent text-sm md:text-lg lg:text-4xl font-semibold font-heading">Agenda</h1> */}
        <h1 className="text-white text-sm md:text-lg lg:text-4xl font-normal font-heading">Agenda</h1>
        <h1 className="text-[#EFC828] text-xs md:text-lg lg:text-3xl font-normal font-heading">Ramadhan Di Kampus</h1>

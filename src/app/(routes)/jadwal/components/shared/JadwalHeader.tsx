...
export default function JadwalHeader(){
  return (
    <div data-aos="fade-up" data-aos-duration="1000" className="relative flex w-[216px] h-[63px] md:w-[335px] md:h-[98px] lg:w-[635px] lg:h-[185px] bg-[#15575B] rounded-[50px] border lg:border-[3px] border-black mx-auto mt-20 md:mt-24 lg:mt-44 justify-center items-center ">

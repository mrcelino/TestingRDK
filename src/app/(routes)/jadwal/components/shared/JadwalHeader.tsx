  ...
  return (
    <div className="relative flex w-[216px] h-[63px] md:w-[335px] md:h-[98px] lg:w-[635px] lg:h-[185px] bg-[#15575B] rounded-[50px] border lg:border-[3px] border-black mx-auto mt-12 md:mt-16 lg:mt-24 justify-center items-center ">
      ...
      <div className="flex flex-col text-center">
        <h1 className="text-white text-sm md:text-lg lg:text-4xl font-normal">Agenda</h1>
        <h1 className="text-[#EFC828] text-xs md:text-lg lg:text-3xl font-normal">Ramadhan Di Kampus</h1>
        <h1 className="text-white text-[10px] md:text-base lg:text-2xl font-semibold">Universitas Gadjah Mada</h1>
      </div>
    </div>
  );
}

    ...
    <>
      ...
      <div className="w-[225px] md:w-[450px] lg:w-[901px] h-[150px] md:h-[250px] lg:h-[500px] flex flex-col mt-8 md:mt-16 lg:mt-32 items-center">
        ...
        <div className="w-full h-full grid grid-cols-[2fr_1fr]">
          {/* left side */}
          <div className="flex flex-col justify-center gap-y-2 md:gap-y-5 lg:gap-y-10 pl-2 md:pl-10 mdp:r-5 grow">
            {/* name */}
          ...
          {/* right side */}
          <div className="flex flex-col justify-center gap-y-2 md:gap-y-10 pr-5 md:pr-10 pl-5">
            <div className="flex w-full">
              ...
              >
                ...
                <img
                  ...
                  alt=""
                  className="absolute -bottom-6 md:-bottom-12 lg:-bottom-24 md:left-3 lg:-left-1 rotate-[-8deg]"
                />
              </div>
            </div>
          </div>

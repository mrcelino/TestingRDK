...
export default function LayoutAgendaNotReleased() {
  return (
    <>
      <div
        data-aos="fade-right"
        data-aos-duration="1000"
        className="w-[201px] h-[41px] md:w-[380px] md:h-[78px] lg:w-[820px] lg:h-[161px] bg-white rounded-[200px] border lg:border-[3px] border-black shadow-lg relative flex justify-center items-center mt-10 md:mt-20 lg:mt-40 mb-10"
      >

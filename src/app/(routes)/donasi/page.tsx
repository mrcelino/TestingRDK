    ...
    <>
      <section className="relative bg-[#15575B]  h-40 lg:h-32 mt-40 border-y-4 border-black flex justify-center">
        <div className="bg-[#F4AA3D] border-4 rounded-[50px] lg:rounded-[70px] border-black h-44 lg:h-40 top-[105px] lg:-top-4 w-[85%] lg:w-[65%] absolute flex flex-col items-center justify-center">
          ...
          <h2 className="font-heading text-xl lg:text-4xl text-white font-bold z-20 max-w-48 text-center lg:max-w-full">wujudkan cinta di bulan suci Ramadan</h2>
        </div>
        <Image
            src="/maskot.webp"
            alt="Maskot"
      ...
      <section className="relative flex min-h-[220px] bg-[#15575B] mt-24 border-y-4 border-black ">
        ...
        <div className="relative w-[55%]">
          <div className="flex flex-col justify-center p-12 absolute inset-0 bg-[#F4AA3D] border-[7px] border-y-0 border-black rounded-l-[100px]">
            ...
            <h2 className='font-heading text-4xl text-white font-bold'>Tebarkan <br/>Keberkahan</h2>
          </div>
        </div>
        <Image
            src="/speaker.png"
...
function Information(){
  return(
    <>
      ...
      <section className='flex mx-52 gap-x-4 mt-10'>
          <div className='font-body w-[82%] p-10 text-white text-xl tracking-wider italic leading-loose font-medium min-h-32 bg-[#F4AA3D] rounded-[35px] border-4 border-black'>
            <h2>Donasi Langsung melalui COD Sekitar Kampus UGM / Sekretariat Jama’ah Shalahuddin (Sayap Selatan Masjid Kampus UGM)</h2>
          </div>
          <div className='relative w-[18%] min-h-32 bg-[#15575B] rounded-[35px] border-4 border-black'>
          <Image
            src="/koin.png"
            alt="Maskot"
            width={300}
            height={300}
            className='size-36 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2'
            />
          </div>
      </section>
    </>
  ...
  return(
    <>
      <section className='flex relative mx-10'>
        ...
        <section className='flex flex-col justify-center min-h-[500px] mt-20'>
            <section className='flex mb-20 mx-28'>
                <div className='flex  items-center justify-center min-h-20 bg-[#F4AA3D] rounded-tl-[30px] w-1/4 border-4 border-r-0 border-black'>
                  <Image
                    src="/paperclip.png"
                    alt="Maskot"
                    width={60}
                ...
                <div className="flex items-center justify-center min-h-20 bg-[#15575B] rounded-br-[30px] w-3/4 border-4 border-black border-l-0">
                  <h1 className='font-heading text-5xl text-white p-4'>Jenis Donasi</h1>
                </div>
            </section>
            <section className='flex gap-28'>
              <div className="relative w-2/6">
                <div className="absolute -top-4 -left-4 w-full h-24 bg-[#CCB087] border-4 border-black"></div>
                <div className="relative bg-[#9F4230] text-white px-4 flex items-center justify-between border-4 border-black w-60 h-24">
                  <span className="font-heading font-bold text-3xl">Uang</span>
                  <Image
                    src="/moneybag.png"
                    alt="Money Bag"
                    width={300}
              ...
              <div className="relative w-2/6">
                ...
                <span className="font-heading font-bold text-3xl">Logistik</span>
                  <Image
                    src="/logistik.png"
                    alt="Logistik"
                    width={300}
              ...
              <div className="relative w-2/6">
                <div className="absolute -top-4 -right-4 w-full h-full bg-[#76D0D5] border-4 border-black"></div>
                <div className="relative bg-[#42A0A6] text-white px-4  flex items-center justify-between border-4 border-black w-60 h-24">
                  <span className="font-heading font-bold text-3xl">Makanan</span>
                      <Image
                        src="/makanan.png"
                        alt="Logistik"
                        width={300}
            ...
            <section className='flex mt-20 gap-16 items-center justify-center'>
              <div className='relative min-h-20 w-full bg-[#15575B] border-[3px] border-black ml-10'>
                ...
                <div className='flex flex-col text-right'>
                  <h2 className='font-body italic px-4 py-2 font-semibold text-white '>Contact Person</h2>
                  <hr className='border-black border-[1.5px] w-[80%] ml-auto'/>
                  <h2 className='font-body italic px-4 py-2 font-semibold text-white'> 081377660189 (Rofi’ Khoirullah)</h2>
                </div>
              </div>
              <div className='relative min-h-20 w-full bg-[#CCB087] border-[3px] border-black mr-10'>
...
function DonasiIftarSahur(){
  return(
    <>
      ...
      <section className='flex flex-col items-center justify-center min-h-32 border-4 rounded-[40px]  border-black  mx-4 xl:mx-[400px] mt-10'>
        <h2 className='text-center text-xl font-body text-[#15575B] italic p-4 max-w-4xl leading-normal'>
      ...
      <section className="relative flex min-h-24 mb-10  bg-white border-black border-4 rounded-full mt-20 xl:mx-96 ">
        <div className="flex items-center bg-[#15575B] border-r-4 border-black rounded-full justify-center w-1/2">
          <h2 className='font-medium font-body text-2xl text-white italic '>Update Donasi</h2>
        </div>
        <div className="relative w-1/2">
          <div className="flex justify-center items-center p-8 absolute inset-0 bg-white border-y-0 rounded-r-full border-black">
            <h2 className='font-semibold font-body text-2xl text-[#15575B] italic'>Rp 1.000.000.000.000,-</h2>
          </div>
        </div>
      </section>

      <section className='flex flex-col xl:mx-[470px] xl:h-[600px] border-black border-4'>
          <div className='flex flex-col items-center justify-center h-3/4 bg-[#15575B]'>
              ...
              <Image
                ...
                height={250}
              />
              <h2 className='text-xl font-body italic text-white mt-4'>a.n Masjid Kampus UGM</h2>
          </div>
          <div className='flex bg-[#F4AA3D] h-1/4 items-center justify-evenly'>
              ...
              <div className='flex flex-col'>
                  <div className='font-body text-lg text-white mt-4'>
                    <h2 className='-mb-1'>7191219494</h2>
                    <h2 className='text-sm'>a.n Masjid Kampus UGM</h2>
                  </div>
...
function DonasiKegiatan(){
  return(
    <>
      ...
      <section className='flex flex-col items-center justify-center min-h-32 border-4 rounded-[40px]  border-black  mx-4 xl:mx-[400px] mt-10'>
        <h2 className='text-center text-xl font-body text-[#15575B] italic p-10 max-w-xl leading-normal'>
        Seluruh donasi digunakan untuk  rangkaian acara Ramadhan Di Kampus UGM 1446 H
        </h2>
      </section>

      <section className="relative flex min-h-24 mb-10  bg-white border-black border-4 rounded-full mt-20 xl:mx-96 ">
        <div className="flex items-center bg-[#F4AA3D] border-r-4 border-black rounded-full justify-center w-1/2">
          <h2 className='font-medium font-body text-2xl text-white italic '>Update Donasi</h2>
        </div>
        <div className="relative w-1/2">
          <div className="flex justify-center items-center p-8 absolute inset-0 bg-white border-y-0 rounded-r-full border-black">

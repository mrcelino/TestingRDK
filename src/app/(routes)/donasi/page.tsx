    ...
    <div data-aos="fade-up" data-aos-duration="1000">
      <section className="relative flex min-h-12 md:min-h-16 xl:min-h-24 mb-10 bg-white border-black border-2 lg:border-4 rounded-full mt-10 md:mt-20 xl:mx-auto mx-4 max-w-xl md:max-w-2xl xl:max-w-4xl sm:mx-auto">
        <div className="flex items-center bg-[#15575B] border-r-2 xl:border-r-4 border-black rounded-full justify-center p-2 w-1/2">
          <h2 className="font-medium font-body text-xs md:text-lg xl:text-2xl text-white italic ">
            Update Donasi
          </h2>
        </div>
    ...
    <div data-aos="fade-down" data-aos-duration="1000">
      <section className="relative bg-[#15575B]  h-24 lg:h-32 border-y-2 md:border-y-4 border-black flex justify-center">
        <div className="bg-[#F4AA3D] border-2 md:border-4 rounded-[50px] lg:rounded-[70px] border-black h-28 p-2 lg:h-40 -top-3 lg:-top-4 w-[85%] lg:w-[65%] absolute flex flex-col items-center justify-center max-w-xl md:max-w-2xl lg:max-w-7xl">
          <h2 className="font-heading text-sm sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl text-white font-medium z-20 xl:mb-4">
            Hadirkan senyuman,
          </h2>
          <h2 className="font-heading text-sm sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl text-white font-medium z-20 md:max-w-2xl text-center lg:max-w-full">
            wujudkan cinta di bulan suci Ramadan
          </h2>
        </div>
        <Image
  ...
  return (
    <>
      <section
        ...
        className="flex bg-white font-body mx-3 sm:mx-auto md:mx-auto text-xs p-4 items-center xl:min-h-32 border-black border-2 xl:border-4 mt-16 xl:mt-36 xl:mx-auto rounded-2xl xl:rounded-[70px] xl:p-10 md:text-lg lg:text-xl lg:leading-loose lg:tracking-widest text-[#15575B] italic max-w-xl md:max-w-2xl lg:max-w-3xl xl:max-w-4xl"
      >
        <h2>
          &ldquo;Kamu sekali-kali tidak akan memperoleh kebajikan (yang
          sempurna) sebelum kamu menginfakkan sebagian harta yang kamu cintai.
          Apa pun yang kamu infakkan, sesungguhnya Allah Maha Mengetahui
          tentangnya.&rdquo;
      ...
      <section
        data-aos="fade-up"
        data-aos-duration="1000"
        className="flex flex-col lg:flex-row justify-center items-center xl:flex-row lg:mx-24 xl:mx-auto gap-x-4 p-4 mt-4 md:mx-4"
      >
        <div className="flex items-center justify-center font-body text-xs md:text-lg xl:w-[82%] p-2 md:p-4 xl:p-10 text-white lg:text-xl xl:tracking-wider italic leading-normal lg:leading-loose font-medium sm:min-h-16 xl:min-h-36 bg-[#F4AA3D] rounded-2xl xl:rounded-[35px] border-2 xl:border-4 border-black max-w-lg md:max-w-2xl xl:max-w-4xl">
          <h2>
            Donasi Langsung melalui COD Sekitar Kampus UGM / Sekretariat Jama’ah
            Shalahuddin (Sayap Selatan Masjid Kampus UGM)
          </h2>
        </div>
        <div
          className={`hidden lg:block relative w-1/2 max-w-28 xl:max-w-40 lg:min-h-28 xl:min-h-40 bg-[#15575B] rounded-2xl xl:rounded-[35px] border-2 xl:border-4 border-black`}
        >
          <Image
  ...
  return (
    <>
      <section
        data-aos="fade-up"
        data-aos-duration="1000"
        className="flex relative mx-2 lg:mx-10 lg:justify-center lg:max-w-8xl 2xl:max-w-7xl 2xl:mx-auto mt-4"
      >
        ...
        <section className="flex flex-col w-full xl:max-w-8xl lg:min-h-[320px] lg:mt-20">
          <section className="flex mb-14 mx-4 md:mx-20 md:mb-20 xl:mx-28 md:flex md:justify-center sm:mx-20 sm:max-w-xl md:max-w-4xl">
            ...
            <div className="flex items-center justify-center min-h-14 bg-[#15575B] rounded-br-[30px] w-3/4 border-2 xl:border-4 xl:border-l-0 border-black border-l-0">
              <h1 className="font-heading text-lg md:text-2xl xl:text-5xl text-white p-2">
                Jenis Donasi
              </h1>
            </div>
          </section>
          <section className="flex flex-col md:flex-row md:flex-wrap lg:flex-nowrap items-center justify-center  gap-10 md:gap-x-16 xl:gap-28 mx-4">
            <div className="relative w-full md:w-2/6 order-2 md:order-1  max-w-[270px]">
              ...
              <div className="relative bg-[#9F4230] text-white px-4 flex items-center justify-between border-2 lg:border-4 border-black w-60 h-16 md:h-24">
                <span className="font-heading text-xl md:text-2xl xl:text-3xl">
                  Uang
                </span>
                <Image
    ...
    <>
      <section className="flex flex-col lg:flex-row mt-10 gap-10 items-center justify-center mx-4 md:mx-auto lg:p-4">
        <div
          data-aos="fade-right"
          data-aos-duration="1000"
          className="relative min-h-14 w-full bg-[#15575B] border-2 md:border-[3px] border-black max-w-sm md:max-w-lg"
        >
          ...
          <div className="flex flex-col text-right">
            <h2 className="font-body text-xs md:text-base italic px-4 py-2 font-semibold text-white ">
              Konfirmasi Donasi
            </h2>
            <hr className="border-black border md:border-[1.5px] w-[80%] ml-auto" />
            <Link
              href={`https://${linkKonfirmasi}`}
              className="hover:text-[#F4AA3D] duration-300 font-body text-xs md:text-base italic px-4 py-2 font-semibold text-white"
            >
              {linkKonfirmasi}
            </Link>
          </div>
        ...
        <div
          data-aos="fade-left"
          data-aos-duration="1000"
          className="relative min-h-14 w-full bg-[#CCB087] border-2 md:border-[3px] border-black max-w-sm md:max-w-lg"
        >
          ...
          <div className="flex flex-col text-left">
            <h2 className="font-body text-xs md:text-base italic px-4 py-2 font-semibold ">
              Contact Person
            </h2>
            <hr className="border-black border md:border-[1.5px] w-[80%]" />
            <Link
              href={`https://wa.me/${waNumber}`}
              className="hover:opacity-50 duration-300 font-body text-xs md:text-base italic px-4 py-2 font-semibold"
            >
  ...
  return (
    <>
      <section
        data-aos="fade-up"
        data-aos-duration="1000"
        className="flex items-center justify-center mx-4 xl:mx-auto md:mt-20"
      >
        <div className="flex items-center justify-center bg-[#F4AA3D] p-4 md:p-8 xl:p-12 w-full mt-20 rounded-full border-2 lg:border-4 border-black max-w-lg md:max-w-2xl lg:max-w-3xl xl:max-w-4xl">
          <p className="text-xl md:text-2xl xl:text-5xl italic font-body ">
      ...
      <section
        data-aos="fade-up"
        data-aos-duration="1000"
        className="flex items-center justify-center md:mt-10 mx-6 md:mx-auto mt-10"
      >
        <div className="flex flex-col bg-white items-center justify-center md:min-h-32 border-2 lg:border-4 rounded-2xl md:rounded-[40px]  border-black max-w-md md:max-w-2xl xl:max-w-full">
          <h2 className="text-center text-xs md:text-xl font-body text-[#15575B] italic p-2 md:p-4 max-w-4xl leading-normal">
            Seluruh donasi digunakan untuk 42.000 porsi buka bersama dan 10.000
            porsi sahur selama acara Ramadhan Di Kampus UGM 1446 H
          </h2>
        </div>
      </section>
      ...
      <section
        data-aos="fade-up"
        data-aos-duration="1000"
        className="flex flex-col h-96 xl:mx-auto xl:h-[600px] border-black border-2 xl:border-4 max-w-xs md:max-w-sm xl:max-w-xl mx-auto"
      >
        <div className="flex flex-col items-center justify-center h-3/4 bg-[#15575B]">
          ...
          />
          <h2 className="text-sm md:text-lg xl:text-xl font-body italic text-white mt-4">
        ...
        <div className="flex bg-[#F4AA3D] h-1/4 items-center justify-evenly">
          ...
          <div className="flex flex-col">
            <div className="font-body text-xs xl:text-lg text-white mt-2 md:mt-4">
              ...
              <h2 className="text-xs xl:text-sm italic">
                a.n. Masjid Kampus UGM
              </h2>
            </div>
      ...
      <KonfirmasiDonasi
        nama="6281377660189 (Rofi’ Khoirullah)"
        linkKonfirmasi="bit.ly/DonasiSahurBukaRDK46H"
      />
    </>
  );
}
  ...
  return (
    <div className="pb-20">
      <section
        data-aos="fade-up"
        data-aos-duration="1000"
        className="flex items-center justify-center mx-4 xl:mx-auto mt-4 md:mt-20"
      >
        <div className="flex items-center justify-center bg-[#15575B] p-4 md:p-8 xl:p-12 w-full mt-20 rounded-full border-2 xl:border-4 border-black max-w-md md:max-w-2xl lg:max-w-3xl xl:max-w-4xl">
          <p className="text-lg md:text-2xl xl:text-5xl italic font-body text-white ">
            Donasi Kegiatan dan Kajian
          </p>
        </div>
      </section>
      ...
      <section
        data-aos="fade-up"
        data-aos-duration="1000"
        className="flex items-center justify-center md:mt-10 mx-6 md:mx-auto xl:mx-auto mt-10"
      >
        <div className="flex bg-white flex-col items-center justify-center md:min-h-32 border-2 lg:border-4 rounded-2xl md:rounded-[40px]  border-black max-w-md md:max-w-2xl xl:max-w-4xl">
          <h2 className="text-center text-xs md:text-xl font-body text-[#15575B] italic p-2 md:p-4 max-w-4xl leading-normal">
            Seluruh donasi digunakan untuk rangkaian acara Ramadhan Di Kampus
            UGM 1446 H
          </h2>
        </div>
      </section>
      ...
      <section
        data-aos="fade-up"
        data-aos-duration="1000"
        className="flex flex-col h-96 mx-auto xl:mx-auto xl:h-[600px] border-black border-2 xl:border-4 max-w-xs md:max-w-sm xl:max-w-xl md:mx-auto"
      >
        <div className="flex flex-col items-center justify-center h-3/4 bg-[#15575B]">
          <Image
            src="/images/donasi/qrislogo.png"
      ...
      <KonfirmasiDonasi
        nama="62895332785320 (Salma Arsepti)"
        linkKonfirmasi="bit.ly/DonasiOperasionalRDK46H"
      />
    </div>
  );
}

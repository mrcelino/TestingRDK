...
<<<<<<< HEAD:src/app/components/artikel/mimbar-subuh/TopArticle.tsx
	...
	useEffect(() => {
		const getArticles = async () => {
			...
			let topArticles = data
				.filter(
					(slide) =>
						slide.category === "Mimbar_Subuh" && slide.like >= 100
				)
				.slice(0, 3);
...
>>>>>>> 7e356a584f05ce2bcead4b15596178d4027896c3:src/app/(routes)/artikel/mimbar-subuh/TopArticle.tsx
}

...
<<<<<<< HEAD:src/app/components/artikel/ramadan-public-lecture/HotArticle.tsx
...
export default function HotArticle({ articles, isLoading }: Props) {
  ...
  const hotArticles = articles.filter(
    (slide) =>
      slide.category === "Mimbar_Subuh" && slide.like >= 50 && slide.like <= 100
  );
...
>>>>>>> 7e356a584f05ce2bcead4b15596178d4027896c3:src/app/(routes)/artikel/mimbar-subuh/HotArticle.tsx
}

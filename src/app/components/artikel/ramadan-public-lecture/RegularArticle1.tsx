...
<<<<<<< HEAD:src/app/components/artikel/ramadan-public-lecture/RegularArticle1.tsx
...
export default function RegularArticles1({ articles, isLoading }: Props) {
  ...
  const regularArticles = article.filter(
    (slide) => slide.category === "RPL" && slide.like >= 0 && slide.like <= 50
  );
  ...
  const displayedArticles =
    regularArticles.length > 0
      ? regularArticles
      : article.filter((slide) => slide.category === "RPL");
...
>>>>>>> 7e356a584f05ce2bcead4b15596178d4027896c3:src/app/(routes)/artikel/ramadan-public-lecture/RegularArticle1.tsx
}

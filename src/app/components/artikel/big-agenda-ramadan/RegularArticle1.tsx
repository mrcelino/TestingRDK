...
<<<<<<< HEAD:src/app/components/artikel/big-agenda-ramadan/RegularArticle1.tsx
...
export default function RegularArticles1({ articles, isLoading }: Props) {
  const [article, setArticles] = useState<Article[]>([...articles]);
...
>>>>>>> 7e356a584f05ce2bcead4b15596178d4027896c3:src/app/(routes)/artikel/big-agenda-ramadan/RegularArticle1.tsx
}

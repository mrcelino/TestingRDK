...
<<<<<<< HEAD:src/app/components/artikel/big-agenda-ramadan/TopArticle.tsx
	...
	useEffect(() => {
		const getArticles = async () => {
			...
			let topArticles = data
				.filter(
					(slide) =>
						slide.category === "Big_Agenda_Ramadhan" && slide.like >= 100
				)
				.slice(0, 3);

		
			if(topArticles.length === 0){
				topArticles = data.filter((slide) => slide.category === "Big_Agenda_Ramadhan").slice(0, 3);
			}
...
>>>>>>> 7e356a584f05ce2bcead4b15596178d4027896c3:src/app/(routes)/artikel/big-agenda-ramadan/TopArticle.tsx
}
